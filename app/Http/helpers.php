<?php
    ...
    // INI :: Funciones para escribir años con letras
    ...
    // FIN:: Funciones para escribir años con letras
    
    // INI:: Funciones para escribir meses con letras
    function getMes($mes){
        $meses = array("01"=>"Enero","02"=>"Febrero","03"=>"Marzo","04"=>"Abril","05"=>"Mayo","06"=>"Junio","07"=>"Julio","08"=>"Agosto","09"=>"Septiembre","10"=>"Octubre","11"=>"Noviembre","12"=>"Diciembre");
        return $meses[$mes];
    }
    // FIN:: Funciones para escribir meses con letras